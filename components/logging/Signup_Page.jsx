...
function Signup_Page() {
    ...
    const initialValues = {'username' : '', 'email': '', 'password': '', 'cpassword': '','isAdminb' : false, 'adminCode' : '' };
        ...
        setIsSubmitting(true);
         if (Object.keys(formErrors).length === 0 && isSubmitting){  
            ...
            const token_response = await fetch(BaseUrl + '/users/register', {
                ...
                body: JSON.stringify({username: fomValues.username, email: fomValues.email, password: fomValues.password, isAdmin:fomValues.isAdminb, Code:fomValues.adminCode}),
            })
    ...
    return (
        <div className="bg-green-50 px-16 py-6 rounded-none sm:rounded-3xl shadow-2xl border-4 border-green-200">
            ...
            <p className="font-medium text-lg text-green-700 mt-2">Create your account</p>
            <form onSubmit={handlesubmit}>
                ...
                <div className="mb-2">
                    <label className="block text-black text-sm font-bold mb-2" htmlFor="cpassword">
                        Confirm Password
                    </label>
                    <input
                        className="shadow appearance-none border border-red rounded w-full py-2 px-3 text-green-600"
                ...
                <div className="mt-3">
                    <div className="flex justify-normal items-center">
                        ...
                        />
                        <label htmlFor="isAdmin" className="text-sm"><b>Admin?</b></label>
                    </div>
                </div>
                {isAnAdmin && (
                    <div className="mb-2 mt-2">
                ...
                <p className={AAP_error.error ? "text-red-700 ml-1 mt-1" : "text-green-700 ml-1 mt-1"}>{AAP_error.msg}</p>
